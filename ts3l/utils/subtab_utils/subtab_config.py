...
class SubTabConfig(BaseConfig):
    ...
    Raises:
        ...
        NotImplementedError: Raised if `input_dim`, `hidden_dim`, or `out_dim` are not specified, 
    ...
    out_dim: int = field(default=None)
    ...
    def __post_init__(self):
        ...
        if self.hidden_dim is None:
            raise NotImplementedError("The dimension of hidden layer must be specified in the 'hidden_dim' attribute.")
        
        if self.out_dim is None:
            raise NotImplementedError("The dimension of output must be specified in the 'out_dim' attribute.")