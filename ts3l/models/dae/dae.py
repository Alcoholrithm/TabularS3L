...
class DAE(TS3LModule):
    def __init__(
        ...
        **kwargs
        ...
        """
        super(DAE, self).__init__(embedding_config)

        self.__encoder = MLP(self.embedding_module.output_dim, hidden_dim, encoder_depth, dropout_rate)
        self.mask_predictor_head = MLP(hidden_dim, embedding_config.input_dim, head_depth, dropout_rate)
        self.reconstruction_head = MLP(hidden_dim, embedding_config.input_dim, head_depth, dropout_rate)
